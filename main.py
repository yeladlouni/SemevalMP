...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', help='dataset to use, one of [sick, msrvid, trecqa, wikiqa, sts, msrp]', default='semeval')
    parser.add_argument('--word-vectors-dir', help='word vectors directory', default='./semeval/')
